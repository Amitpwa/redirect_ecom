...
<div class="body__overlay"></div>
        ...
        <!--<div class="single__slide animation__style01 slider__fixed--height" style="background-image: url(http://store.amitcorpo.com/media/banner/639492415_af7crop.png);background-repeat: no-repeat;background-size: cover;">-->
        
        <div class="slider__container slider--one bg__cat--3">
            <div class="slide__container slider__activation__wrap owl-carousel">
                <?php while($rowBanner=mysqli_fetch_assoc($resBanner)){?>
                <div class="single__slide animation__style01 slider__fixed--height" style="background-image: url(<?php echo BANNER_SITE_PATH.$rowBanner['image']?>);background-repeat: no-repeat;background-size: cover;">                    
                    <div class="container">
