...
// function handleBuyNow($con,$productLink,$pid,$USER_ID){
...
// if(isset($_GET['productlink'],$_GET['userId'])) {
// 	$productlink = $_GET['productlink'];
// 	$userId = $_GET['userId'];
//     handleBuyNow($productlink,$userId);
// 	mysqli_query($con,"insert into ext_click(cust_name,product_id,clicked_on) values('$USER_ID','$pid','$clicked_on')");
...
// function ext_link_add($con,$uid,$pid){
// 	$added_on=date('Y-m-d h:i:s');
// 	mysqli_query($con,"insert into wishlist(cust_name,product,clicked_on) values('$uid','$pid','$added_on')");
// }
