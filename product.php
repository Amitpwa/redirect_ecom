...
<script>
	function handelBuyandRedirect(userid, productid, redirectlink) {
		// alert(userid + productid + redirectlink);
		jQuery.ajax({
			...
			success: function(data) {
				if (data === "yes") {
					...
					alert("Something went wrong. Please try Clicking Again.");
				}
			}
		});
