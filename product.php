                            ...
                            <div class="ht__product__dtl">
								...
								<div id="is_cart_box_show" class="<?php echo $is_cart_box_show?>">
									...
									<!--if (isset($_SESSION['loggedin']) || $_SESSION['loggedin'] == true) {
										<a class="fr__btn buy_now" href="<?php echo $get_product['0']['link']?>">Buy Now</a>;
									}
										 else {
										<a class="fr__btn buy_now"  href="login.php">Buy Now</a>; -->

									<?php if(isset($_SESSION['USER_ID'])) //after login ye button dikhao
										{
										?>
									<!-- <a class="fr__btn buy_now" href="functions.inc.php?productlink=<?php echo $get_product['0']['link']?>&userId=<?php echo $_SESSION['USER_ID']?>">Buy Now</a> -->
									
									<!-- <a class="fr__btn buy_now" href="#"onclick="handleBuyNow()">Buy Now</a> -->

									<button class="fr__btn buy_now" onClick="handelBuy(<?= $_SESSION['USER_ID'] ?>,<?= $get_product['0']['id'] ?>,'<?= $get_product['0']['link']?>')">Buy now</button>




									
<!-- insert product to the table -->
...
<!-- insert product to the table -->
									...
									<?php  }else{ // if user login nahi to ye dikhao?> 
										<a class="fr__btn buy_now" href="login.php">login to buy now</a>
...
<script>
	function handelBuy(userid,productid,redirectlink) { 
		alert("asfdads");
		function add_data_and_redirect() {
            jQuery.ajax({
                url: "<?= SITE_PATH ?>ajax.php",
                method: "POST",
                data: {
                    userid : userid,
					productid : productid
